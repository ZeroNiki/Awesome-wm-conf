...
-- Wallpaper
gears.wallpaper.maximized("/home/zero/Pictures/Wallpaper/ALLqk82.png", 1, true)
...
beautiful.init("/home/zero/.config/awesome/Gruv/theme.lua")
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "a", function()
		awful.util.spawn("sh /home/zero/Documents/wallp.sh")
	end),
	...
	end, { description = "telegram-desktop", group = "applications" }),
	...
	end, { description = "steam", group = "applications" }),
	...
	awful.key({ modkey }, "z", function()
		awful.util.spawn("sleek")
	end, { description = "ToDo Sleek", group = "applications" }),
