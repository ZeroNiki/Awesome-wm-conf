...
beautiful.init(gears.filesystem.get_themes_dir() .. "Everforest/theme.lua")
beautiful.init("/home/zero/.config/awesome/Everforest/theme.lua")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "r",
        function() awful.util.spawn("nitrogen --set-zoom-fill --random ~/Pictures/Wallpaper ") end),
    ...
    --Sleek
    awful.key({ modkey }, "z", function() awful.util.spawn('sleek') end,
        { description = "ToDo Sleek", group = "applications" }),
